import java.util.*;
public class IB_CycleInUndirectedGraph {
    ...
    public static class Solution {
        public int solve(int A, ArrayList<ArrayList<Integer>> B) {
            ...
            for(ArrayList<Integer> point : B){
                adj[point.get(0)-1].add(point.get(1)-1);
                adj[point.get(1)-1].add(point.get(0)-1);
            }
            Integer []vis = new Integer[A];
            for(int i =0;i<A;i++){
                vis[i] =-2;
            }
            ...
            for(int i =0;i<A;i++){
                ...
                while(!st.empty()){
                    System.out.println("----");
                    curr = st.pop();
                    for(Integer jk : adj[curr]){
                        if(vis[jk]!=-2 && jk -vis[curr] !=0){
                            return 1;
                        }
                        vis[jk]= curr;
                        st.push(jk);
